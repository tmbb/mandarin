defmodule <%= inspect Module.concat([context.web_module, context.alias, schema.web_namespace, schema.alias]) %>Controller do
  use <%= inspect context.web_module %>.Mandarin, :controller
