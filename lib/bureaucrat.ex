defmodule Bureaucrat do
  ...
  The package relies a lot on generators, and Bureaucrat itself provides a minimal API at runtime.
  ...
  The basic idea is tha Bureaucrat generates normal Phoenix contexts, views, templates and controllers,
  ...
  Bureaucrat relies heavily on the [forage](https://github.com/tmbb/forage) package
