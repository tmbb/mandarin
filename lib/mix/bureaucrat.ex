defmodule Mix.Bureaucrat do
  # Conveniences for Bureaucrat tasks.
  @moduledoc false
  ...
  ## Examples
      ...
      iex> Mix.Bureaucrat.inflect("user")
      [alias: "User",
       human: "User",
       base: "Bureaucrat",
       web_module: "BureaucratWeb",
       module: "Bureaucrat.User",
       scoped: "User",
       singular: "user",
       path: "user"]

      iex> Mix.Bureaucrat.inflect("Admin.User")
      [alias: "User",
       human: "User",
       base: "Bureaucrat",
       web_module: "BureaucratWeb",
       module: "Bureaucrat.Admin.User",
       scoped: "Admin.User",
       singular: "user",
       path: "admin/user"]

      iex> Mix.Bureaucrat.inflect("Admin.SuperUser")
      [alias: "SuperUser",
       human: "Super user",
       base: "Bureaucrat",
       web_module: "BureaucratWeb",
       module: "Bureaucrat.Admin.SuperUser",
  ...
  def inflect(singular) do
    ...
    scoped     = Bureaucrat.Naming.camelize(singular)
    path       = Bureaucrat.Naming.underscore(scoped)
    singular   = String.split(path, "/") |> List.last
    module     = Module.concat(base, scoped) |> inspect
    alias      = String.split(module, ".") |> List.last
    human      = Bureaucrat.Naming.humanize(singular)
  ...
  defp app_base(app) do
    case Application.get_env(app, :namespace, app) do
      ^app -> app |> to_string |> Bureaucrat.Naming.camelize()
      mod  -> mod |> inspect()
    end
  end
  ...
  and falls back to Bureaucrat's `priv` directory.
  """
    ...
    case Application.get_env(this_otp_app, :generators)[:context_app] do
      ...
      false ->
        ...
        via cli option:
            ...
            mix bureaucrat.gen.[task] --context-app some_app
