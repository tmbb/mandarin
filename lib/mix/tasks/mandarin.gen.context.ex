defmodule Mix.Tasks.Mandarin.Gen.Context do
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise(
        "mix mandarin.gen.context must be invoked from within your *_web application root directory"
      )
    end
  ...
  def raise_with_help(msg) do
    ...
    mix mandarin.gen.html, mandarin.gen.json, mandarin.gen.live, and mandarin.gen.context
    ...
    For example:
        ...
        mix mandarin.gen.live Accounts User users name:string
  ...
  def prompt_for_code_injection(%Context{} = context) do
    ...
    cond do
      ...
      Context.pre_existing?(context) && !merge_with_existing_context?(context) ->
        System.halt()
    end
  end
