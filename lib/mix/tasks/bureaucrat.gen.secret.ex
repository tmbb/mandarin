defmodule Mix.Tasks.Bureaucrat.Gen.Secret do
  @shortdoc "Generates a secret"

  @moduledoc """
  Generates a secret and prints it to the terminal.

      mix bureaucrat.gen.secret [length]

  By default, mix bureaucrat.gen.secret generates a key 64 characters long.
  ...
  defp invalid_args! do
    Mix.raise "mix bureaucrat.gen.secret expects a length as integer or no argument at all"
  end
end
