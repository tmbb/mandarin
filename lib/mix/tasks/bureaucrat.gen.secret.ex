defmodule Mix.Tasks.Mandarin.Gen.Secret do
  @shortdoc "Generates a secret"

  @moduledoc """
  Generates a secret and prints it to the terminal.

      mix mandarin.gen.secret [length]

  By default, mix mandarin.gen.secret generates a key 64 characters long.
  ...
  defp invalid_args! do
    Mix.raise("mix mandarin.gen.secret expects a length as integer or no argument at all")
  end
end
