defmodule Mix.Tasks.Mandarin.Gen.Schema do
  @shortdoc "Generates an Ecto schema and migration file"

  @moduledoc """
  Generates an Ecto schema and migration.

      $ mix mandarin.gen.schema Blog.Post blog_posts title:string views:integer
  ...
  Via CLI:
      ...
      $ mix mandarin.gen.schema Blog.Post blog_posts title:string views:integer --context-app marketing
  ...
  the type makes it default to `:string`:
      ...
      $ mix mandarin.gen.schema Blog.Post blog_posts title views:integer
  ...
  referenced table:
      ...
      $ mix mandarin.gen.schema Blog.Post blog_posts title user_id:references:users
  ...
  type of the underlying array element to be given too:
      ...
      $ mix mandarin.gen.schema Blog.Post blog_posts tags:array:string

  Unique columns can be automatically generated by using:

      $ mix mandarin.gen.schema Blog.Post blog_posts title:unique unique_int:integer:unique

  Redact columns can be automatically generated by using:

      $ mix mandarin.gen.schema Accounts.Superhero superheroes secret_identity:redact password:string:redact

  Ecto.Enum fields can be generated by using:

      $ mix mandarin.gen.schema Blog.Post blog_posts title status:enum:unpublished:published:deleted
  ...
  a `--table` option may be provided. For example:
      ...
      $ mix mandarin.gen.schema Blog.Post posts --table cms_posts
  ...
  folder with option `--repo`:
      ...
      $ mix mandarin.gen.schema Blog.Post posts --repo MyApp.Repo.Auth
  ...
  the migration folder path:
      ...
      $ mix mandarin.gen.schema Blog.Post posts --migration-dir /path/to/directory
  ...
  A prefix can be specified with the `--prefix` flags. For example:
      ...
      $ mix mandarin.gen.schema Blog.Post posts --prefix blog
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise "mix mandarin.gen.schema must be invoked from within your *_web application root directory"
    end
  ...
  defp prompt_for_conflicts(schema) do
    proceed_without_confirmation = Keyword.get(schema.opts, :yes)
      ...
      migration_dir =
        cond do
          ...
          opts[:repo] ->
            ...
            Mix.Mandarin.context_app_path(ctx_app, "priv/#{repo_name}/migrations/")

          true ->
            Mix.Mandarin.context_app_path(ctx_app, "priv/repo/migrations/")
        end
  ...
  def validate_args!([schema, plural | _] = args, help) do
    cond do
      ...
      String.contains?(plural, ":") or plural != Mandarin.Naming.underscore(plural) ->
  ...
  def raise_with_help(msg) do
    ...
    mix mandarin.gen.schema expects both a module name and
    the plural of the generated resource followed by
    any number of attributes:

        mix mandarin.gen.schema Blog.Post blog_posts title:string
    """
  end
