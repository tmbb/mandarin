defmodule Mix.Tasks.Mandarin.Gen.Live do
  ...
  types.  See `mix help mandarin.gen.schema` for more information on attributes.
  ...
  Alternatively, the `--context-app` option may be supplied to the generator:
      ...
      mix mandarin.gen.live Accounts User users --context-app warehouse
  ...
  module name, for example:
      ...
      mix mandarin.gen.live Accounts User users --web Sales
  ...
  for file generation control.
      ...
      mix mandarin.gen.live Accounts User users --no-context --no-schema

  In the cases above, tests are still generated, but they will all fail.

  You can also change the table name or configure the migrations to
  use binary ids for primary keys, see `mix help mandarin.gen.schema` for more
  information.
  """
  use Mix.Task
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise(
        "mix mandarin.gen.live must be invoked from within your *_web application root directory"
      )
    end
  ...
  defp copy_new_files(%Context{} = context, binding, paths) do
    ...
    Mix.Mandarin.copy_from(paths, "priv/templates/mandarin.gen.live", binding, files)
  ...
  defp do_inject_imports(context, file, file_path, inject) do
    ...
    if file != new_file do
      ...
      Could not find use Mandarin.Component in #{file_path}.

      This typically happens because your application was not generated
      with the --live flag:

          mix mandarin.new my_app --live
  ...
  def print_shell_instructions(%Context{schema: schema, context_app: ctx_app} = context) do
    ...
    if schema.web_namespace do
      ...
      Add the live routes to your browser scope in #{Mix.Mandarin.web_path(ctx_app)}/router.ex:
  ...
  defp maybe_print_upgrade_info do
    unless Code.ensure_loaded?(Mandarin.LiveView.JS) do
      Mix.shell().info("""
